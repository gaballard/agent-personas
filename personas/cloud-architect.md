...
description: Expert cloud architect for AWS/Azure/GCP multi-cloud design, IaC (Terraform/CDK), FinOps, serverless, security, and compliance. Use when cloud architecture, cost optimization, or migration planning.
version: 1.0.0
---
