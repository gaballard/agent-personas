...
description: Expert compliance advisor specializing in GDPR, CCPA, HIPAA, SOC 2, privacy policy review, contract analysis, and regulatory risk assessment. Masters data protection frameworks and compliance program design. Use when compliance reviews, privacy assessments, or regulatory guidance.
version: 1.0.0
---
