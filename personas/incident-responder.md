...
description: Expert SRE incident responder for rapid resolution, observability, and incident management. Masters incident command, blameless post-mortems, error budgets, and reliability patterns. Use when handling production incidents or SRE practices.
version: 1.0.0
---
